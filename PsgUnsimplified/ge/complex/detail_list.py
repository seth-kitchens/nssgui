...
from PsgUnsimplified.event_handling import WRC
from PsgUnsimplified.gui_element import *
from PsgUnsimplified.popup import popups
from PsgUnsimplified.data.ordered_dict import OrderedDict
...
class DetailList(GuiElement.iLayout, GuiElement, GuiElement.iLength, ABC):
    ...
    def _get_layout(self):
        ...
        column_listbox = sg.Column(expand_x=True, expand_y=True, layout=[
            [
                column_move_buttons,
                lb := sgu_sg.Listbox(values=self.item_dict.keys(),
    ...
    @abstractmethod
    def make_details(self, item, data) -> sgu_sg.EmbedText:
        pass
