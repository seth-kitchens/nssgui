...
from PsgUnsimplified.style import colors
...
class InputUnits(GuiElement.iRow, GuiElement):
    ...
    def __init__(self,
        ...
        self.auto_scale_units = auto_scale_units if auto_scale_units != None else sgu_g.auto_scale_units
    ...
    def _get_row(self):
        ...
        self.gem.add_ge(sgu_el.Dropdown(self.keys['Unit'], '', self.unit_value.get_symbols(), self.unit_value.get_degree_symbol()))
        row = [
            sg.Text(self.text),
