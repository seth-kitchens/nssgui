...
from PsgUnsimplified.event_handling import WRC, EventManager
from PsgUnsimplified.sg.utils import MenuDict
...
class GuiElement(EventManager, GuiElementLayoutManager):
    ...
    def check_double_click(self, click_id=None):
        ...
        if (click_time - self.prev_click_time) < sgu_g.double_click_secs:
