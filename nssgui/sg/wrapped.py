...
class Listbox(sg.Listbox):
    ...
    def _RightClickMenuCallback(self, event):
        ...
        since this won't be called for right clicks afterwards and the select won't happen.
        An empty listbox or rows with no intended right-click menu must be given something for now.
        """
